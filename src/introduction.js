Game.rooms.introductionPage = {
    ...
    text: () => `<span class="drop">C</span>hipmunk was peering into Owl's telescope, holding still as best he could.
    ...
    "You won't *actually* see it up close," said Chipmunk.
...
Game.rooms.crackTelescopeRoom = {
    ...
    text: () => `Mistress Badger took a closer look at the telescope. "Actually... I do see a tiny teensy little--"

    *Crack!* The glass fractured in a spiderweb pattern from the edge, and splintered into
...
Game.rooms.noDamageTelescopeRoom = {
    ...
    text: () => `"It's okay!" said Owl. "It's really okay!"
