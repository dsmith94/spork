...
function refresh() {
    ...
    if (display) {
        display.innerHTML = processText(containerName, __displayObjects.join(" ")) + actions;
    }
    __displayObjects = [];
}
...
function showNextButton() {
    ...
    nextButtonElement.innerHTML = `<p><button type="submit" id="Next-Button" onclick="clickNextButton();">➞</button></p>`;
}
